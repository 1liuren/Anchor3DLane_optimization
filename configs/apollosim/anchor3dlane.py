...
data_root = 'Apollo_Sim_3D_Lane_Release'
split = 'standard'
img_norm_cfg = dict(
...
model = dict(
    ...
    strides=(1, 2, 1, 1),
    style='pytorch'),
    pretrained = 'pretrained/apollo_anchor3dlane.pth',
    y_steps = anchor_y_steps,
...
work_dir = 'output/apollosim/anchor3dlane_optimization'
